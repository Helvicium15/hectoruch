  ...
  return (
    <section className="min-h-screen flex flex-col items-center justify-center relative px-6 py-20 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center space-y-8 animate-in fade-in duration-1000 relative z-10">
        <div className="inline-block px-6 py-2 bg-primary/20 border border-primary/30 rounded-full mb-4">
          <p className="font-inter text-sm md:text-base text-primary font-bold tracking-wider uppercase">
            Visual Designer • 3D Artist
          </p>
        </div>
        
        <h1 className="font-playfair text-6xl md:text-8xl font-black tracking-tighter leading-none">
          <span className="bg-gradient-to-r from-primary via-secondary to-accent bg-clip-text text-transparent">
            HECTOR URIBE
          </span>
        </h1>
        
        <div className="h-2 w-40 mx-auto bg-gradient-to-r from-primary to-accent rounded-full" />
        
        <p className="font-inter text-xl md:text-2xl text-foreground/90 max-w-2xl mx-auto leading-relaxed font-medium">
          Pushing boundaries with bold visuals, immersive 3D worlds, and cutting-edge design
        </p>
