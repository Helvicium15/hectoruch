      ...
      <div className="flex-1 relative px-6 md:px-12 flex items-center">
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mt-8">
            <p className={`text-sm md:text-base text-muted-foreground leading-relaxed bg-black px-4 py-3 rounded-lg inline-block transition-all duration-700 delay-700 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              {t.heroDescription}
            </p>
